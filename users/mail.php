...
ob_start();
if(isset($_POST['name']) && isset($_POST['email']) && isset($_POST['otp']))
{
    $name = $_POST['name'];
    $email = $_POST['email'];
    $otp    = $_POST['otp'];
    $BASE_URL    = $_POST['BASE_URL'];
        ////////////////////////////////////////////email///////////////////////////////////////////////////////////////////////////////////////////////
                    ...
                    $mail->SMTPSecure = 'tls';
                    $mail->IsHTML(true);
                    $mail->Subject = 'Engayg - Verify your email.';
                                                                             ...
                                                                             <table>
                                                                                ...
                                                                                <tr height='100'>                                                                
                                                                                    <td align='left' valign='middle' height='100' style='color: #444444; font-family: calibri; font-size:14px; line-height:18px; text-align:justify;padding-right:10px;'>
                                                                                        To confirm your Email address. Just copy the below four digit verification code and verify same from app.
                                                                                        <br /><br />                                                                    
                                                                                        Your four digit OTP is <span style='color:#3b5999'><strong>".$otp."</strong></span>, don't share this with anyone.
                                                                                        <br /><br />
                                                                                        If you did not request this OTP, please let us know immediately at <a href='mailto:info@engayg.com' style='color: #3b5999;'>info@engayg.com</a>
                                                                                        <br /><br />
                    ...
                    //$mail->AddAddress("utk619a@gmail.com");
                    if(!$mail->Send()) 
                    {
                        echo "Failed";
                    }
